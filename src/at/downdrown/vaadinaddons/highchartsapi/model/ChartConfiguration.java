...
public class ChartConfiguration {
    ...
    /**
     * Set the chart's background color. Use the {@link Colors} interface for this purpose.
     ...
     * Maybe the {@link Colors} interface is helpful herefore.
     *
    ...
    public String getHighChartValue() throws HighChartsException {
        ...
        builder.append(", exporting: { enabled: " + false + " }");
