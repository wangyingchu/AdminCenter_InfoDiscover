 ...
 */
public class Scatter3DChartParametersInput extends BaseChartParametersInput{
    ...
    public Scatter3DChartParametersInput(UserClientInfo userClientInfo,List<String> measurablePropertiesNameList,List<String> stringPropertiesNameList) {
        this.setMargin(true);
