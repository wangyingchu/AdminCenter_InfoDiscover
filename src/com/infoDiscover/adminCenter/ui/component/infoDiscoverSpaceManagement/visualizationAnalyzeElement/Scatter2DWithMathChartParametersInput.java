 ...
 */
public class Scatter2DWithMathChartParametersInput extends BaseChartParametersInput{
    ...
    public Scatter2DWithMathChartParametersInput(UserClientInfo userClientInfo,List<String> measurablePropertiesNameList,List<String> stringPropertiesNameList) {
        this.setMargin(true);
    ...
    public String getParametersQueryString() {
        ...
        parametersQuerySb.append("&values=");
