...
public class RuleDetail extends VerticalLayout implements View,
    ...
    public void deleteCurrentDiscoverSpace(){
        ...
        Label confirmMessage=new Label("<span style='color:#CE0000;'><span style='font-weight:bold;'>"+FontAwesome.EXCLAMATION_TRIANGLE.getHtml()+
                " 请确认是否删除信息发现空间  <b style='color:#333333;'>"+this.ruleName +"</b>," +
                "执行删除操作将会永久性的删除该发现空间中的所有数据。</span><br/>注意：此项操作不可撤销执行结果。</span>", ContentMode.HTML);
        ...
        Button.ClickListener confirmButtonClickListener = new Button.ClickListener() {
            ...
            public void buttonClick(final Button.ClickEvent event) {
                ...
                boolean deleteActivitySpaceResult=InfoDiscoverSpaceOperationUtil
                        .deleteDiscoverSpace(self.ruleName);
                if(deleteActivitySpaceResult){
                    DiscoverSpaceDeletedEvent discoverSpaceDeletedEvent=new
                            DiscoverSpaceDeletedEvent(self.ruleName);
